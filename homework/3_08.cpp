//li3_8.cpp文件：this指针使用示例,this=&当前对象
#include<iostream>
using namespace std;
class Date
{
...
void Date::Display()
{
	cout << "the this is";
	cout << this << endl;                             	//输出当前主调对象的地址     
	cout << "the year is ";         	//输出当前对象的year成员的地址
	cout << &year << endl;
	cout << "month is ";        	//输出当前对象的month成员的地址
	cout << &month << endl;
...
int main()
{
	...
	cout << "DateA is :" << &DateA << endl;              //输出对象DateA的地址     
	DateA.Display();
	cout << "DateB is :" << &DateB << endl;              	//输出对象DateB的地址  
	DateB.Display();
	getchar();
	return 0;
}